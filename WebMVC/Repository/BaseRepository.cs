...
namespace WebMVC.Repository
{
    public class BaseRepository<T> : IBaseRepository<T> where T: class
    {
        ...
        public async Task<T> GetFirstOrDefaultAsync(string url, int Id, string token = "")
        {
        ...
        public async Task<bool> AddAsync(string url, T objToCreate, string token = "")
        {
        ...
        public async Task<bool> RemoveAsync(string url, int Id, string token = "")
        {
